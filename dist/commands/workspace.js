...
import { openDb, hasDb, searchWorkspace, getAllPages, getAllDatabases, getDbProperties, getDatabase, } from "../util/workspace-db.js";
    ...
    cmd
        ...
        try {
            ...
            if (!database && properties.length === 0) {
                ...
                const match = allDbs.find((d) => d.id.includes(databaseId) || d.title.toLowerCase().includes(databaseId.toLowerCase()));
                if (match) {
