...
export function removeSkill(claudeDir) {
    const dir = join(claudeDir, "skills", SKILL_DIRNAME);
    if (!existsSync(skillFilePath(claudeDir)))
        return "not_found";
    rmSync(dir, { recursive: true, force: true });
    return "removed";
}
export function hasSkill(claudeDir) {
